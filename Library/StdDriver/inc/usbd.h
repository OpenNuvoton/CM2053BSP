...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. CM2053 series supports 17  hardware endpoint ID. This parameter could be 0 ~ 16.
  *
  *
...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. CM2053 series supports 17 endpoint ID. This parameter could be 0 ~ 16.
  *
