 ...
 * @file     canfd.c
 * @version  V1.00
 * @brief    CM2053 series CAN FD driver source file
 *
...
void CANFD_Open(CANFD_T *psCanfd, CANFD_FD_T *psCanfdStr)
{
    ...
    /* Workaround for https://www.nuvoton.com/resource-download.jsp?tp_GUID=DA07-CM2053&currentFolder=/products/microcontrollers/arm-cortex-m23-mcus/CM2053-series/ */
    if ((SYS->PDID == 0x00F250E0) || (SYS->PDID == 0x00F25000) || (SYS->PDID == 0x00F25001)||(SYS->PDID == 0x06225000))
    {
        g_u32Workaround = 1UL;
    }
