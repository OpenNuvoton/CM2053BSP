/******************************************************************************
 * @file     usbd_user.h
 * @brief    CM2053 series USB driver header file
 *
 * @note
...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. CM2053 Series supports 8 hardware endpoint ID. This parameter could be 0 ~ 7.
  *
  * @return     None
  *
...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. CM2053 Series supports 8 endpoint ID. This parameter could be 0 ~ 7.
  *
...
/*@}*/ /* end of group CM2053_USBD_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group CM2053_USBD_Driver */

/*@}*/ /* end of group CM2053_Device_Driver */
