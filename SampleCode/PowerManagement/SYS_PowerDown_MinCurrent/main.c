 ...
 * @return      None
 *
 * @details     The PB default IRQ, declared in startup_CM2053.s.
 */
void GPB_IRQHandler(void)
{
...
int32_t main(void)
{
    ...
    /* To measure Power-down current on NuMaker-CM2053LE board, remove R16 and measure the current on Ammeter Connector */
